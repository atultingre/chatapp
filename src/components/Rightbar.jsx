        ...
        <Box flex={2} p={2} sx={{ display:{xs:"none", sm:"block" }}} >
            <Box position="fixed" width={300}>
                ...
                <AvatarGroup max={7}>
                    ...
                    <Avatar alt="Trevor Henderson" src="http://material-ui.com/static/images/avatar/6.jpg" />
                    <Avatar alt="Trevor Henderson" src="http://material-ui.com/static/images/avatar/7.jpg" />
